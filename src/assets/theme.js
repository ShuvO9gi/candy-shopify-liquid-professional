        ...
        theme.cart
          ...
          .then(
            function (cart) {
              ...
              if (qty == 0) {
                var row = this.form.querySelector(
                  '.cart__item[data-key="' + key + '"]'
                );
  ...
  theme.VariantAvailability = (function () {
    ...
    availability.prototype = Object.assign({}, availability.prototype, {
      ...
      manageOptionState: function (option, values) {
        var group = this.form.querySelector(
        ...
        updateContent: function (variantId) {
          ...
          fetch(variantSectionUrl)
            ...
            .then(function (storeAvailabilityHTML) {
              ...
              self.container.querySelector(selectors.productTitle).textContent =
                self.productTitle;
            });
        },
      }
  ...
  theme.Collection = (function () {
    ...
    Collection.prototype = Object.assign({}, Collection.prototype, {
      ...
      initFilters: function () {
        ...
        config.combineTags =
          document
            .querySelector(selectors.sidebar)
            .getAttribute("data-combine-tags") == "true";
  ...
  theme.Product = (function () {
    ...
    function Product(container) {
      ...
      this.cache = {
        ...
        comparePriceA11y: container.querySelector(
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      initVariants: function () {
        ...
        if (theme.settings.dynamicVariantsEnable) {
          var currentVariantJson = document.getElementById(
      ...
      openModalProduct: function () {
        ...
        if (!this.settings.modalInit) {
          var formHolder = this.container.querySelector(
          ...
          fetch(url)
            ...
            .then(
              function (html) {
                var parser = new DOMParser();
                var doc = parser.parseFromString(html, "text/html");
                this.cache.form = doc.querySelector(
